...
for i in range(150):
    if i < 50:
        franka.set_dofs_position(np.array([1, 1, 0, 0, 0.04, 0.04]), motors_dof_idx)
    elif i < 100:
        franka.set_dofs_position(np.array([-1, 0.8, 0.5, -0.5, 0.04, 0.04]), motors_dof_idx)
    else:
        franka.set_dofs_position(np.array([0, 0, 0, 0, 0, 0]), motors_dof_idx)
...
for i in range(1250):
    if i == 0:
        franka.control_dofs_position(
            np.array([1, 1, 0, 0, 0.04, 0.04]),
            motors_dof_idx,
        )
    elif i == 250:
        franka.control_dofs_position(
            np.array([-1, 0.8, 0.5, -0.5, 0.04, 0.04]),
            motors_dof_idx,
        )
    elif i == 500:
        franka.control_dofs_position(
